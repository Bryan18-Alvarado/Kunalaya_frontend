...
import quizData from '../constants/tradiciones_quiz.json';

const QUIZ_TIME = 30; // segundos por pregunta

export default function TradicionesQuizScreen() {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.resultSubtitle}>Has terminado el quiz de Tradiciones Nicaragüenses</Text>
